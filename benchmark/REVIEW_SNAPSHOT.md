...
The public-EHT evaluation is observation-domain only. The snapshot is intended to make the benchmark, manifests, figures, tables, and manuscript claims inspectable by editors and referees without claiming a telescope-accurate end-to-end EHT pipeline.
