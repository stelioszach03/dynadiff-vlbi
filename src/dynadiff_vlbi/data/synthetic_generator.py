...
def generate_split_dataset(
    ...
    for _ in range(num_sequences):
        ...
        dirty.append(measurement_batch.dirty_reconstruction.astype(np.float32))
        vis_real.append(measurement_batch.noisy_visibilities.real.astype(np.float32))
        vis_imag.append(measurement_batch.noisy_visibilities.imag.astype(np.float32))
